...
const MyJobs = () => {
  const email = "harshgoyal1331@gmail.com";
  ...
  return (
    <div className="max-w-screen-2iner mx-auto xl:px-24 px-4">
      <div className="my-jobs-container">
        ...
        <div className="p-2 text-center mb-2 search-box">
          <input
            type="text"
            name="search"
            id="search"
          ...
          />
          <button
            className="bg-blue rounded-sm text-white font-semibold px-8 py-2 mb-4"
      ...
      {/* Table to store the search data */}
